...
save_pickle("Simester Two/Unit 3/ContentFiltering/data/dot9_nsfw_words.p", words)
words.to_csv("Simester Two/Unit 3/ContentFiltering/data/dot9_nsfw_words.csv")
